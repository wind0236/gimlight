...
monster position char entityAttr name maxHp defence power =
        actor position char entityAttr name maxHp defence power True True False ActorEntity True noEvent

player :: Coord -> Entity
player c = actor c "@" whiteAttr "Player" 30 2 5 True True True ActorEntity False noEvent
